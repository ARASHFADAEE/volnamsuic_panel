                ...
                <div class="container-lg d-flex flex-column px-3 py-2">
                    ...
                    <div>
                        <div class="d-flex align-items-center gap-2 justify-content-center pb-1 border-bottom border-2 border-gray-700">
                            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/icons/volna-music_logo.svg'); ?>" alt="<?php bloginfo('name'); ?>" />
                        </div>
        ...
        <section class="main-container h-100 d-flex flex-column flex-grow-1 bg-gray-50">
            <nav class="w-100">
                <div class="d-flex px-3 py-2 h-auto bg-black-700 bg-md-white justify-content-between align-items-center">
                    ...
                    <figure>
                        <img class="d-block d-md-none img-fluid" src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/Logo.png'); ?>" alt="" />
                    </figure>
                ...
                <section class="container border px-3 py-2 bg-white rounded-2">
                    <div class="d-flex justify-content-between border-bottom pb-2">
                        <div class="d-flex align-items-center">
                            ...
                            <span class="fs-xs fw-medium ps-2">جدیدترین مقالات</span>
                        </div>
                        <a class="px-2 py-1 bg-gray-50 rounded-1 gray-btn-hover" href="<?php echo home_url('/blog'); ?>">
                            ...
                            <div class="save-ausbildung text-black d-flex bg-white flex-md-column p-2 border justify-content-between gap-2 align-items-center rounded-2">
                                <div class="position-relative d-flex ausbildung-img-container">
                                    ...
                                    <button class="position-absolute rounded-2 d-flex justify-content-center align-items-center ausbildung-save-btn">
                                        <img class="ausbildung-save" src="<?php echo MUSIC_PANEL_URL; ?>assets/icons/save-brand-icon.svg" alt="" />
                                    </button>
                                    <button class="position-absolute rounded-2 d-flex justify-content-center align-items-center ausbildung-share-btn">
                                        <img class="ausbildung-share" src="<?php echo MUSIC_PANEL_URL; ?>assets/icons/share-icon.svg" alt="" />
                                    </button>
                                </div>
