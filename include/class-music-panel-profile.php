...
class Music_Panel_Profile {
    
    public function __construct() {
        // اضافه کردن اکشن برای پردازش فرم ویرایش پروفایل
        add_action('admin_post_update_user_profile', array($this, 'process_profile_update'));
        add_action('admin_post_nopriv_update_user_profile', array($this, 'redirect_to_login'));
        
        // اضافه کردن اکشن برای آپلود تصویر پروفایل با AJAX
        add_action('wp_ajax_upload_profile_image', array($this, 'process_profile_image_upload'));
        add_action('wp_ajax_nopriv_upload_profile_image', array($this, 'ajax_login_required'));
    }
     ...
     */
    public function get_profile_image_url($user_id, $size = 'thumbnail') {
